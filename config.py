...
class Config:
    ...
    STEEL_CDP_URL = os.getenv("STEEL_CDP_URL")
    STEEL_PUBLIC_URL = os.getenv("STEEL_PUBLIC_URL")
    GTWY_BROWSER_IDLE_TIMEOUT_SECONDS = int(os.getenv("GTWY_BROWSER_IDLE_TIMEOUT_SECONDS", "300"))
    GTWY_BROWSER_HANDOFF_TIMEOUT_SECONDS = int(os.getenv("GTWY_BROWSER_HANDOFF_TIMEOUT_SECONDS", "900"))
    GTWY_BROWSER_SNAPSHOT_MAX_CHARS = int(os.getenv("GTWY_BROWSER_SNAPSHOT_MAX_CHARS", "15000"))
    GTWY_BROWSER_MAX_TABS = int(os.getenv("GTWY_BROWSER_MAX_TABS", "10"))
    GTWY_BROWSER_PERSIST_COOKIES = os.getenv("GTWY_BROWSER_PERSIST_COOKIES", "false")
    GTWY_BROWSER_COOKIE_TTL_DAYS = int(os.getenv("GTWY_BROWSER_COOKIE_TTL_DAYS", "30"))
    GTWY_BROWSER_COOKIE_CACHE_TTL_SECONDS = int(os.getenv("GTWY_BROWSER_COOKIE_CACHE_TTL_SECONDS", "3600"))
