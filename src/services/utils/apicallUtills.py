...
async def delete_cache_for_prompt_update(bridge_id):
    # Construct cache keys
    cache_key_1 = f"{redis_keys['get_bridge_data_']}{str(bridge_id)}"
    cache_key_2 = f"{redis_keys['bridge_data_with_tools_']}{str(bridge_id)}"
