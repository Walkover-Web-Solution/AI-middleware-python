...
def tool_call_formatter(configuration: dict, service: str, variables: dict, variables_path: dict) -> dict: # changes
    if service == service_name['openai_completion'] or service == service_name['open_router'] or service == service_name['mistral'] or service == service_name['gemini'] or service == service_name['ai_ml'] or service == service_name['grok']:
        data_to_send =  [
            {
                'type': 'function',
                'function': {
