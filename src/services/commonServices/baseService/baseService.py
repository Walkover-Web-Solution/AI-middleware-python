...
from ..grok.grokModelRun import grok_model_run
    ...
    async def chats(self, configuration, apikey, service, count=0):
        try:
            ...
            if service == service_name['openai']:
                ...
                response = await grok_model_run(configuration, apikey, self.execution_time_logs, self.bridge_id, self.timer, self.message_id, self.org_id, self.name, self.org_name, service, count, self.token_calculator)
