        ...
        if self.type == 'image':
            ...
            if self.reasoning_model:
                ...
                if not self.image_data:
                    ...
                    self.customConfig["messages"] = [ {"role": "system", "content": self.configuration['prompt']}] + conversation + ([{'role': 'user', 'content': [{"type": "text", "text": self.user}, {"type": "image_url", "image_url": {"url": self.image_data}}]}] if self.user else [])
