    ...
    def gpt_4o():
        configuration = {
            ...
            "parallel_tool_calls": {
                ...
                "input_cost": 2.50,
                "output_cost": 10.00,
                "description" : "GPT-4o omni is OpenAI’s latest AI model, offering faster, more efficient, and highly capable multimodal processing for text, images, and potentially audio. It improves reasoning, context retention, and real-time interaction while being more cost-effective. Designed for seamless AI experiences, it balances power, speed, and versatility",
                "knowledge_cutoff" : "Oct 01, 2023",
                "usecase" : [""]
            }
        }
    ...
    def text_embedding_ada_002():
        configuration = {
            ...
            "specification" : {
                "input_cost": "",
                "output_cost": "",
                "description" : "text-embedding-ada-002 is our improved, more performant version of our ada embedding model. Embeddings are a numerical representation of text that can be used to measure the relatedness between two pieces of text. Embeddings are useful for search, clustering, recommendations, anomaly detection, and classification tasks.",
                "knowledge_cutoff" : "",
                "usecase" : [""]
            },
        }
    ...
    def dall_e_3():
        configuration = {
            ...
            "specification" : {
                "input_cost": 0.01,
                "output_cost":0.03,
                "description" : "DALL·E 3 is the latest version of OpenAI's image generation model. It creates highly detailed and realistic images from text prompts, with even better understanding of complex descriptions compared to DALL·E",
                "knowledge_cutoff" : "",
                "usecase" : [""]
            },
        }
